import { QueryFindBook } from './book.query'; // Gantilah 'your-module' dengan path yang sesuai

describe('QueryFindBook', () => {
  it('should create a valid FindOptions object', () => {
    ...
    const findOptions = QueryFindBook(where, order, pagination);
